...
| **openpouch** | reachable | reachable | CLI-first anonymous preview; root and both assets byte-identical from both egresses; fixed 72-hour expiry |
...
- **reachable from mainland China**: ship-page, shipstatic, here-now, show, aft-page, dropley, flypod, BrewPage, ht-ml.app, meethtml, Display.dev, shiply.now, shippage.ai, openpouch
